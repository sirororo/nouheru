...
dat_member.assess
 ...
 WHERE mst_product.shop_code=dat_member.code AND mst_product.gyousyu=4';		/* 検索  */
...
<main>
  ...
  <nav>
    ...
    <br>
            ...
            <h1 class="text-center">専門の経理・会計</h1>
...
?>
    ...
    <div class="row featurette">
      <div class="col-md-7">
        <h2 class="featurette-heading">農家の経理・会計の悩み</h2>
        <p class="lead">
          「経理の知識も経験もないため、そもそも何から始めていいかわからない。」<br>「農業に専念するために経理業務にはできるだけ時間やコストをかけたくない。」
        </p>
      </div>
      <div class="col-md-5">
      <img src="../product/gazou/keiri1.jpg" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500"  x="50%" y="50%"  dy=".3em">
    ...
    <div class="row featurette">
      <div class="col-md-7 order-md-2">
        <h2 class="featurette-heading">農業専門の経理代行とは？</h2>
        <p class="lead">日常の簿記記帳・経理事務を専門の社労士・公認会計士・税理士・行政書士が代行します。</p>
      </div>
      <div class="col-md-5 order-md-1">
      <img src="../product/gazou/keiri2.jpg" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500"  x="50%" y="50%"  dy=".3em">
    ...
    <div class="row featurette">
      <div class="col-md-7">
        <h2 class="featurette-heading">経理・会計の依頼の際の注意</h2>
        <p class="lead">ルール１：依頼する事業者によってサポート内容が異なるため確認してください。</p>
      </div>
      <div class="col-md-5">
      <img src="../product/gazou/keiri3.jpg" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500"  x="50%" y="50%"  dy=".3em">
