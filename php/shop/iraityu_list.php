...
try
{
  ...
  iraityu_sales_product.code
   ...
   ON iraityu_sales.shop_code=dat_member.code		/*	業者の個人情報*/
  
   WHERE iraityu_sales.request_code=?';
...
<main>
  ...
  <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <img src="../top/images/irai_gamen.jpg" width="100%" height="100%" alt="メインイメージ画像">
        <div class="container">
