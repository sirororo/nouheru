...
dat_member.assess
 ...
 WHERE mst_product.shop_code=dat_member.code AND mst_product.gyousyu=1';		/* 検索  */
...
<main>
  ...
  <div class="container marketing">
    ...
    <br>
            ...
            <h1 class="text-center">農業代行・委託サービス</h1>
...
?>
    ...
    <div class="row featurette">
      <div class="col-md-7">
        <h2 class="featurette-heading">農作業の悩み</h2>
        <p class="lead">「農地が耕作放棄地にならないように管理し続けなければならない。」<br>「作物を収穫するための人手が見つからない。」<br>「高齢化で体力がなくなってきている。」
      </p>
      </div>
      <div class="col-md-5">
        <img src="../product/gazou/daikou1.jpg" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500"  x="50%" y="50%"  dy=".3em">
    ...
    <div class="row featurette">
      <div class="col-md-7 order-md-2">
        <h2 class="featurette-heading">農業代行・委託サービスとは？</h2>
        <p class="lead">農業代行・委託サービスとは、農作業や農地の維持管理を代わりにやってくれるサービスです。<br>農作業料金については<a href="https://www.nca.or.jp/images/nousagyou20.pdf">全国農業会議所</a>を参照してください。</p>
      </div>
      <div class="col-md-5 order-md-1">
      <img src="../product/gazou/daikou2.jpg" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500"  x="50%" y="50%"  dy=".3em">
    ...
    <div class="row featurette">
      <div class="col-md-7">
        <h2 class="featurette-heading">農業代行・委託の注意</h2>
        <p class="lead">ルール１：誰でも登録して自分のサービスを提供できます。<br>ルール２：サービス向上のために依頼者側は口コミ・評価・値段を記述します。</p>
      </div>
      <div class="col-md-5">
      <img src="../product/gazou/daikou3.jpg" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500"  x="50%" y="50%"  dy=".3em">
